...
gen-ent: # Generate Ent codes | 生成 Ent 的代码
	go run -mod=mod entgo.io/ent/cmd/ent generate --feature intercept,schema/snapshot,sql/lock,sql/upsert,sql/execquery --template glob="./ent/template/*.tmpl" ./ent/schema
